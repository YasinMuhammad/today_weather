# Weather Widget with Node API Proxy Server
...
You can add on any other query params as needed when hitting the /api endpoint such as https://yourdomain/api?q=Islamabad without having to add your key in the client
